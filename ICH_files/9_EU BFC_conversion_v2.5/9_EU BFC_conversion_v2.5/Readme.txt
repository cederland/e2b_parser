...
What's New in 2.5 R3 to R2 conversions
-------------------------------------
-Bug fix for downgrade.xsl -- Correction to handle UCUM units that are not mapped to R2 codes
-Bug fix for downgrade-b4.xsl , fix to drug start and end dates not populating in some instances
-Big fix for downgrade-b4.xsl & downgrade-b5.xsl drug additional field length 


Updates in 2.4 R3 to R2 conversions
-------------------------------------
